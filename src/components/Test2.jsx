        ...
        <>
            ...
            <div className="home_grid1">
                ...
                <div className="home_entImgs home_grid3">
                    <img src="./slide-img2.jpg" alt="" />
                </div>
                <div className="home_entInfo home_grid4">
                    <div className="quote">
                        <blockquote></blockquote>
                    </div>
                    <div className="text">At Code Club, we shape future tech professionals in CSE engineering while honing
                        essential soft skills and communication prowess. Join us on a transformative journey, where innovation meets holistic
                        growth at the Coding Crafters Club, established in 2023.<br />Unlock your coding potentials</div>
                </div>
